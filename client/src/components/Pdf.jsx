...
export default class Pdf extends Component {
    constructor(props) {
        super(props);
        this.state = {
            path: require("../assets/pdf/Rejestry.pdf"),
            pdf: null,
            pageNum: 1,
            endPage: 1
        };
    ...
    changePage = offset => {
        ...
        const newPage = pageNum + offset < 1 ? 1 : pageNum + offset > endPage ? endPage : pageNum + offset;
        if(newPage!==pageNum){
                ...
                <Content >
                    ...
                    <Row type="flex" justify={'center'}>
                        <Col xs={7}>
                            <Row type="flex" justify={'center'}>
                                <Col xs={12}>
                                    <Button type="primary" onClick={() => this.changePage(-1)} icon='left'>
                                        Poprzednia
                                    </Button>
                                </Col>

                                <Col xs={12}>
                                    <Button type="primary" onClick={() => this.changePage(1)} icon='right'>
                                        Następna
                                    </Button>
